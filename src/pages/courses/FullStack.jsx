...
function CourseModules() {
  ...
  return (
    <section className="mx-auto max-w-[90%] px-4 py-14">
      <h2 className="!mb-8 !text-center !text-2xl !font-bold !font-black !text-black">Course Modules</h2>
  ...
  return (
    <div className="">
      ...
      <main className="min-h-screen">
        ...
        >
          <p className="text-2xl font-bold text-black">Ready to become a Full-Stack Development Wizard?</p>
        </motion.div>
